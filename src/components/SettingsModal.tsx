...
export function SettingsModal({ initialConfig, onSaved }: Props) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-[220] bg-black/45 p-3 backdrop-blur-sm sm:p-6" onMouseDown={requestClose}>
          <div className="flex min-h-full items-center justify-center">
            <section
              className="app-panel flex max-h-[calc(100vh-1.5rem)] w-full max-w-3xl flex-col overflow-hidden sm:max-h-[calc(100vh-3rem)]"
            ...
            >
              <div className="flex items-start justify-between gap-4 border-b border-stone-200/70 px-5 py-5 sm:px-8">
                <div>
                  ...
                  <h2 className="mt-3 text-2xl font-semibold text-[var(--ink)] sm:text-3xl">配置你的专属 AI 模型</h2>
                </div>
